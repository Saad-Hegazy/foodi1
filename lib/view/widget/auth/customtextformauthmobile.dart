...
class CustomTextFormAuthMobile extends StatefulWidget {
  ...
  const CustomTextFormAuthMobile({
    super.key,
  ...
  @override
  State<CustomTextFormAuthMobile> createState() => _CustomTextFormAuthState();
}

class _CustomTextFormAuthState extends State<CustomTextFormAuthMobile> {
  @override
  void initState() {
    super.initState();
