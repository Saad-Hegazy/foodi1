...
class ProductDetailsItemModel extends StatelessWidget {
  const ProductDetailsItemModel({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    Get.put(ProductDetailsControllerItemModelImp());
    return Scaffold(
      body: GetBuilder<ProductDetailsControllerItemModelImp>(
        builder: (controller) => HandlingDataView(
          statusRequest: controller.statusRequest,
          widget: Column(
            children: [
              const TopProductPageDetailsItemModel(),
              Expanded(
        ...
        child: Padding(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              onPressed: () {
                ProductDetailsControllerItemModelImp   controller= Get.put(ProductDetailsControllerItemModelImp());
